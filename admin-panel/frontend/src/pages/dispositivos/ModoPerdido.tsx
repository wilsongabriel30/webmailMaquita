...
const NOMBRE: Record<string, string> = { localizar: "Localizar ahora", alarma: "Hacer sonar", bloquear: "Bloquear pantalla", desbloquear: "Fin del modo perdido", borrar: "Borrado remoto" };
