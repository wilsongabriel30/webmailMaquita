...
const navSections = [
  ...
  },
  {
    title: "Destinatarios",
    items: [
      { to: "/mailboxes", label: "Buzones", icon: "M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" },
  ...
  },
  {
    title: "Herramientas",
    items: [
      { to: "/mailviewer", label: "Visor de buzones", icon: "M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" },
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/air", label: "AIR — investigación y respuesta", icon: "M9 12l2 2 4-4 M12 3a9 9 0 100 18 9 9 0 000-18z" },
      { to: "/sso", label: "SSO / Identidad", icon: "M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z" },
      { to: "/agents", label: "Agentes IA", icon: "M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" },
      { to: "/copiloto", label: "Copiloto Maquita", icon: "M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.86 9.86 0 01-4-.8L3 21l1.8-4A8 8 0 1121 12z" },
      { to: "/rag", label: "RAG — tu correo", icon: "M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" },
      { to: "/conditional-access", label: "Acceso Condicional", icon: "M12 11c0-1.105.895-2 2-2s2 .895 2 2v3H8v-3c0-1.105.895-2 2-2 M12 15v2 M5 9V7a7 7 0 0114 0v2 M5 9h14v11a1 1 0 01-1 1H6a1 1 0 01-1-1V9z" },
      ...
      { to: "/anti-suplantacion", label: "Anti-suplantación y políticas", icon: "M10 6H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V8a2 2 0 00-2-2h-5m-4 0V5a2 2 0 114 0v1m-4 0a2 2 0 104 0M12 14a2 2 0 100-4 2 2 0 000 4zm0 0c1.3 0 2.4.8 2.8 2M9 16a3 3 0 012.8-2" },
