...
const navSections = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/password-audit", label: "Cuentas sin clave válida", icon: "M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z" },
      ...
      { to: "/login-health", label: "Accesos externos", icon: "M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" },
      { to: "/antispam", label: "Filtro Avanzado", icon: "M12 2l7 4v6c0 5-3.5 8-7 10-3.5-2-7-5-7-10V6l7-4z" },
      { to: "/outbound", label: "Protección de salida", icon: "M12 2l7 4v6c0 5-3.5 8-7 10-3.5-2-7-5-7-10V6l7-4z M9 12l3 3M12 8v4" },
