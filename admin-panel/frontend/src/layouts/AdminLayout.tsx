...
const navSections = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/office", label: "OnlyOffice", help: "Visor y editor de documentos Office del webmail (OnlyOffice): dirección del Document Server y secreto JWT. Los archivos viven en el Almacén (Drive).", icon: "M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z M13 3v5h5 M9 13h6 M9 17h6" },
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/dispositivos", label: "Teléfonos institucionales", help: "Celulares de la organización: inventario y custodio, estado que reportan, mensajes urgentes con acuse y códigos de enrolamiento.", icon: "M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" },
    ],
  },
  {
    title: "Compliance",
