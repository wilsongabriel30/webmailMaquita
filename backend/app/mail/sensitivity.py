...
LABELS = {
    ...
    "Interna":      {"ext_ok": True,  "color": "#1f4f83", "bg": "#e7f0fb", "text": "INTERNA \u00b7 uso interno"},
    "Confidencial": {"ext_ok": False, "color": "#8a5510", "bg": "#fbf1e0", "text": "CONFIDENCIAL \u00b7 no reenviar fuera de la organizaci\u00f3n"},
    "Restringida":  {"ext_ok": False, "color": "#8f2417", "bg": "#fbe9e7", "text": "RESTRINGIDA \u00b7 informaci\u00f3n sensible, circulaci\u00f3n limitada"},
}
...
def banner_html(label: str) -> str:
    ...
    c = LABELS[l]
    return (
        '<div style="margin:0 0 12px;padding:8px 14px;border-left:4px solid ' + c["color"] + ';'
