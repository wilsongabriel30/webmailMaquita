...
from app.contacts.routers.search import router as contacts_router
from app.sieve.router import router as sieve_router
from app.identities.router import router as identities_router
from app.mail.router import router as legacy_mail_router
...
app.include_router(legacy_mail_router)


@app.get("/api/health")
async def health():
    return {"status": "ok", "service": "maquita-webmail", "version": "0.5.0"}
