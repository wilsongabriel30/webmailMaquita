...
from app.dispositivos.wifis import router as dispositivos_wifis_router
...
app.include_router(dispositivos_wifis_router)  # wifi de las sedes compartido con la flota
