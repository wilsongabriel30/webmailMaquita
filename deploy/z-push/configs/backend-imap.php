...
define('IMAP_SERVER', 'host.docker.internal');   // Dovecot del anfitrión

// connecting to default port (143)
define('IMAP_PORT', 993);

// best cross-platform compatibility (see http://php.net/imap_open for options)
define('IMAP_OPTIONS', '/ssl/novalidate-cert/norsh');   // por IP interna: el cert es del nombre público
...
// SMTP Parameters
//      mail : no params
$imap_smtp_params = array('host' => 'ssl://host.docker.internal', 'port' => 465, 'auth' => true, 'username' => 'imap_username', 'password' => 'imap_password', 'verify_peer' => false, 'verify_peer_name' => false, 'allow_self_signed' => true);
//      sendmail
